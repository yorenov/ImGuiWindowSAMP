...
namespace ImGui
{
    ...
    IMGUI_API bool          Tab(const ImGuiID id, bool selectable, ImTextureID image, const ImVec2& size_arg);
    ...
    IMGUI_API bool          InputTextMultiline(const char* label, ImTextureID image, char* buf, size_t buf_size, const ImVec2& size = ImVec2(0, 0), ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    ...
    IMGUI_API bool          InputScalar(const char* label, ImTextureID image, ImGuiDataType data_type, void* p_data, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputScalarN(const char* label, ImTextureID image, ImGuiDataType data_type, void* p_data, int components, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0);
    ...
    IMGUI_API bool          BeginChildFrame(ImGuiID id, ImTextureID image, const ImVec2& size, ImGuiWindowFlags flags = 0); // helper to create a child window / scrolling region that looks like a normal widget frame

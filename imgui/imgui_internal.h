...
#define IM_DRAWLIST_CIRCLE_AUTO_SEGMENT_MIN                     804
#define IM_DRAWLIST_CIRCLE_AUTO_SEGMENT_MAX                     812
...
//#endif
    ...
    IMGUI_API bool          BeginChildEx(const char* name, ImTextureID image, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    ...
    IMGUI_API bool          TabButton(const char* label, ImTextureID image, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          TabIco(const char* label, ImTextureID image, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          TempInputText(const ImRect& bb, ImTextureID image, ImGuiID id, const char* label, char* buf, int buf_size, ImGuiInputTextFlags flags);
    IMGUI_API bool          TempInputScalar(const ImRect& bb, ImTextureID image, ImGuiID id, const char* label, ImGuiDataType data_type, void* p_data, const char* format, const void* p_clamp_min = NULL, const void* p_clamp_max = NULL);
